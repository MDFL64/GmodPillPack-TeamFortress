...
pk_pills.register("tf_hhh",{
	...
	sounds={
		fun=pk_pills.helpers.makeList("vo/halloween_boss/knight_laugh0#.wav",4),
		melee=pk_pills.helpers.makeList("vo/halloween_boss/knight_attack0#.wav",4),
		melee_hit=pk_pills.helpers.makeList("weapons/demo_charge_hit_flesh#.wav",3),
		die="vo/halloween_boss/knight_death02.wav"
	},
	attack={
		mode="auto",
...
pk_pills.register("tf_ghost",{
	...
	sounds={
		fun=pk_pills.helpers.makeList("vo/halloween_boo#.wav",7)
	},
	muteSteps=true,
	attack={
		mode="trigger",
...
pk_pills.register("tf_eye",{
	...
	attack={
		...
		func=function(ply,ent)
			...
			if ent:GetSkin()==2 then
				rocket.particle="critical_rocket_red"
	...
	health=10000,
	sounds={
		die="vo/halloween_eyeball/eyeball_boss_pain01.wav",
		shoot = "weapons/rocket_shoot_crit.wav",
		laugh= pk_pills.helpers.makeList("vo/halloween_eyeball/eyeball_laugh0#.wav",3)
	}
})
...
pk_pills.register("tf_wizard",{
	...
	sounds={
		...
		melee=pk_pills.helpers.makeList("vo/halloween_merasmus/sf12_attacks0#.wav",3,9),
		melee_hit=pk_pills.helpers.makeList("weapons/demo_charge_hit_flesh#.wav",3),
		die="vo/halloween_merasmus/sf12_defeated12.wav",
